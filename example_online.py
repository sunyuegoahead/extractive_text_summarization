...
if __name__ == "__main__":
    ...
    print('\n\nLSA Ozsoy:\n')
    summary1 = lsa_o.summarize(txt, length=5)

    for sentence in summary1:
        print(sentence)

    print('\n\nLSA Steinberger:\n')
    summary2 = lsa_s.summarize(txt, length=5)

    for sentence in summary2:
        print(sentence)

    print('\n\nRelevance:\n')
    summary3 = relevance.summarize(txt, length=5)

    for sentence in summary3:
        print(sentence)

    print('\n\nTextRank:\n')
    summary4 = textrank.summarize(txt, length=5)
